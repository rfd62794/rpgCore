...
class SystemConfig:
    ...
    world: WorldConfig = field(default_factory=lambda: WorldConfig(seed=""))
    mind: MindConfig = field(default_factory=lambda: MindConfig(seed=""))
    body: BodyConfig = field(default_factory=BodyConfig)
    chronos: ChronosConfig = field(default_factory=lambda: ChronosConfig(seed=""))
    persona: PersonaConfig = field(default_factory=lambda: PersonaConfig(seed=""))
    voyager: VoyagerConfig = field(default_factory=lambda: VoyagerConfig(seed=""))
