...
- src\apps\slime_clan\territorial_grid.py: Territorial Grid Prototype — Spec-001, Session 009
...
- src\apps\space\ship_genetics.py: Ship Genetics Proxy — Re-export from apps/rpg/logic/ship_genetics.py
...
- src\dgt_engine\foundation\interfaces\visuals.py: Visual Types — Foundation-Tier Shared Protocols
...
- src\dgt_engine\game_engine\actors\pawn_navigation.py: Voyager Navigation — The Body
...
- src\dgt_engine\systems\body\ppu_adapter.py: PPU Adapter — Environment-Aware Rendering Router
...
- src\dgt_engine\systems\models\asset_schemas.py: Asset Schemas — Engine-Tier Data Models
...
- src\dgt_engine\tools\asset_models.py: Asset Models — Backward-Compatibility Shim
...
- scripts\sweeper.py: DGT Platform — Sweeper: Import-Linkage Mapper & Dead Code Detector
